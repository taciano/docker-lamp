...
(1, 'Nome do Cliente 1', '+5551987654321', 'email1@teste.com', 'Rua Martinho Lutero, 301.'),
(2, 'Nome do Cliente 2', '+5551987654321', 'email2@teste.com', 'Rua Martinho Lutero, 301'),
(3, 'Nome do Cliente 3', '+5551987654321', 'email3@teste.com', 'Rua Martinho Lutero, 301'),
(4, 'Nome do Cliente 4', '+5551987654321', 'email4@teste.com', 'Rua Martinho Lutero, 301'),
(5, 'Nome do Cliente 6', '+5551987654321', 'email5@teste.com', 'Rua Martinho Lutero, 301');
...
(1, 'home', '<h1>Bem vindo!!!</h1>\r\n<p>Conteudos da home</p>'),
(2, 'about', '<h1>Sobre</h1>\r\n<p>Conteudos da pagina sobre</p>'),
(3, 'another', '<h1>Outra</h1>\r\n<p>Conteudos da outra pagina</p>');
...
(1, 'Produto 1', '10,00', 'Descricao detalhada do produto 1, categoria 1', 1),
(2, 'Produto 2', '11,00', 'Descricao detalhada do produto 2, categoria 2', 2),
(3, 'Produto 3', '12,00', 'Descricao detalhada do produto 2, categoria 3', 3),
(4, 'Produto 4', '17,00', 'Descricao detalhada do produto 4, categoria 1', 1),
(5, 'Produto 5', '13,00', 'Descricao detalhada do produto 5, categoria 2', 2),
(6, 'Produto 6', '12,00', 'Descricao detalhada do produto 6, categoria 3', 3),
(7, 'Produto 7', '12,00', 'Descricao detalhada do produto 7, categoria 3', 3),
(8, 'Produto 8', '12,00', 'Descricao detalhada do produto 8, categoria 3', 3),
(9, 'Produto 9', '13,00', 'Descricao detalhada do produto 9, categoria 2', 2);
...
CREATE USER 'pw'@'%' IDENTIFIED WITH mysql_native_password BY 'pw123';
  GRANT ALL PRIVILEGES ON *.* TO 'pw'@'%' WITH GRANT OPTION;ALTER USER 'pw'@'%' 
